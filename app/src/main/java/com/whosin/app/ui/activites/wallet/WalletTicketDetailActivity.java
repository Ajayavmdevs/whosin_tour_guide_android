...
import com.whosin.app.comman.TimerUtils;
import com.whosin.app.comman.Utils;
import com.whosin.app.comman.ui.UiUtils;
import com.whosin.app.databinding.ActivityWalletTicketDetailBinding;
import com.whosin.app.databinding.ItemJpSubHotelRoomBinding;
import com.whosin.app.databinding.ItemTicketDetailBinding;
...
import com.whosin.app.service.models.rayna.RaynaTicketDownloadModel;
...
import com.whosin.app.ui.activites.JpHotel.JPHotelFeaturesSheet;
import com.whosin.app.ui.activites.comman.BaseActivity;
import com.whosin.app.ui.activites.raynaTicket.BottomSheets.CancelBookingDialog;
import com.whosin.app.ui.activites.raynaTicket.BottomSheets.CancellationPolicyBottomSheet;
import com.whosin.app.ui.adapter.BookingAddOnAdapter;
...
//                    String refundAmount = String.valueOf(Utils.roundDoubleValueToDouble(calculateRefundAmount(myWalletModel.getWhosinTicket().getAmount(),policy)));
                    ...
                    if (Objects.equals(refundAmount, "0.0")) {
                        ...
                        Graphics.alertDialogYesNoBtnWithUIFlag(activity, "WHOS'IN", fullText, false, getValue("no"), getValue("yes"), aBoolean -> {
                            if (aBoolean) {
                                requestTravleDeskBookingCancel(model.getBookingId(),myWalletModel.getTraveldeskTicket().getId(),model.getOptionData().getName());
                            }
                        });
