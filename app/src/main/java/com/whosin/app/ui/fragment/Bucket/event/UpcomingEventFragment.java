...
public class UpcomingEventFragment extends BaseFragment {
    ...
    private void setAdapter() {
        binding.upcomingRecycler.setLayoutManager( new LinearLayoutManager( requireActivity(), LinearLayoutManager.VERTICAL, false ) );
        binding.upcomingRecycler.setAdapter( eventListAdapter );
        ...
        DataService.shared( requireActivity() ).requestUpcomingHistory( new RestCallback<ContainerListModel<BucketEventListModel>>(this) {
            ...
            public void result(ContainerListModel<BucketEventListModel> model, String error) {
                ...
                if (model.data != null && !model.data.isEmpty()) {
                    ...
                    eventListAdapter.updateData( model.data );
                } else {
    ...
    public class EventListAdapter<T extends DiffIdentifier> extends DiffAdapter<T, RecyclerView.ViewHolder> {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            return new EventListAdapter.ViewHolder( UiUtils.getViewBy( parent, R.layout.bucket_event_list_item ) );
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            private EventUserListAdapter<InviteFriendModel> eventUserListAdapter;
        ...
        public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
            ...
            if (model != null) {
                ...
                if (model.getUser() != null) {
                    ...
                    Graphics.loadRoundImage(model.getUser().getImage(), viewHolder.mBinding.imgUserLogo);
                }
