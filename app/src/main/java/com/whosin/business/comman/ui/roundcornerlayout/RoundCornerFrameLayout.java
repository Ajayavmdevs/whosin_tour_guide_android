...
public final class RoundCornerFrameLayout extends FrameLayout {
                ...
                (Function1)
                        (new Function1() {
                            ...
                            public final void invoke(@NotNull Canvas it) {
                                ...
                                RoundCornerFrameLayout.super.draw(it);
                            }
                        }));
    }
        ...
        this.canvasRounder.round(
                ...
                (Function1)
                        (new Function1() {
                            ...
                            public final void invoke(@NotNull Canvas it) {
                                Intrinsics.checkParameterIsNotNull(it, "it");
                                RoundCornerFrameLayout.super.dispatchDraw(it);
                            }
                        }));
    }
    ...
    public RoundCornerFrameLayout(
            @NonNull Context context, @androidx.annotation.Nullable AttributeSet attrs) {
        super(context, attrs);
