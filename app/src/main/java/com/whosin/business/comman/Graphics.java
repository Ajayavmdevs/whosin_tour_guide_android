...
import com.whosin.business.comman.interfaces.ActionDoneCallback;
    ...
    public static void loadImageWithFirstLetter(String url, ImageView imageView, String name) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            if (!TextUtils.isEmpty(firstLetters.toString())) {
                ...
                com.whosin.business.comman.TextDrawable drawable = new com.whosin.business.comman.TextDrawable.Builder()
