package com.whosin.business.service.storyViewer;
...
public class StoriesProgressView extends LinearLayout {
    ...
    private final LayoutParams SPACE_LAYOUT_PARAM = new LayoutParams(6, LayoutParams.WRAP_CONTENT);
    ...
    private void init(Context context, @Nullable AttributeSet attrs) {
        ...
        cornerRadius = typedArray.getDimension(R.styleable.StoriesProgressView2_cornerRadius , 0);
        typedArray.recycle();
        bindViews();
    }
    ...
    public boolean isStartedStory(int index) {
        if (index < progressBars.size()) {
            return progressBars.get(index).isStarted();
        }
        return false;
    }
