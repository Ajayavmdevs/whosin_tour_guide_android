...
public class TourOptionsModel implements DiffIdentifier, ModelProtocol {
    ...
    @SerializedName("whosinAdultPrice")
    @Expose
    private Float whosinAdultPrice;

    @SerializedName("whosinChildPrice")
    @Expose
    private Float whosinChildPrice;

    @SerializedName("whosinInfantPrice")
    @Expose
    private Float whosinInfantPrice;

    @SerializedName("whosinFinalAmount")
    @Expose
    private Float whosinFinalAmount;
    ...
    public Float getWhosinAdultPrice() {
        return whosinAdultPrice;
    }

    public void setWhosinAdultPrice(Float whosinAdultPrice) {
        this.whosinAdultPrice = whosinAdultPrice;
    }

    public Float getWhosinChildPrice() {
        return whosinChildPrice;
    }

    public void setWhosinChildPrice(Float whosinChildPrice) {
        this.whosinChildPrice = whosinChildPrice;
    }

    public Float getWhosinInfantPrice() {
        return whosinInfantPrice;
    }

    public void setWhosinInfantPrice(Float whosinInfantPrice) {
        this.whosinInfantPrice = whosinInfantPrice;
    }

    public Float getWhosinFinalAmount() {
        return whosinFinalAmount;
    }

    public void setWhosinFinalAmount(Float whosinFinalAmount) {
        this.whosinFinalAmount = whosinFinalAmount;
    }
