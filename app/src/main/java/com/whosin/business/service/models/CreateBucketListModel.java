...
public class CreateBucketListModel implements DiffIdentifier,ModelProtocol {
    ...
    @Expose
    private List<ContactListModel> sharedWith;
    ...
    public List<ContactListModel> getSharedWith() {
        return sharedWith != null ? sharedWith : new ArrayList<>();
    }

    public void setSharedWith(List<ContactListModel> sharedWith) {
