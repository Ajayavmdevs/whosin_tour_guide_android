...
import com.whosin.business.service.models.JuniperHotelModels.JPHotelBoardForWalletModel;
import com.whosin.business.service.models.JuniperHotelModels.JPHotelInfoModel;
...
public class TravelDeskOptionDataModel implements DiffIdentifier, ModelProtocol {
    ...
    @SerializedName("tourGuideMarkup")
    @Expose
    private Float tourGuideMarkup;

    @SerializedName("whosinPricePerAdult")
    @Expose
    private Float whosinPricePerAdult;

    @SerializedName("whosinPricePerChild")
    @Expose
    private Float whosinPricePerChild;

    @SerializedName("whosinPricePerInfant")
    @Expose
    private Float whosinPricePerInfant;

    @SerializedName("whosinPricePerTrip")
    @Expose
    private Float whosinPricePerTrip;

    public Float getWhosinPricePerTrip() {
        return whosinPricePerTrip;
    }

    public void setWhosinPricePerTrip(Float whosinPricePerTrip) {
        this.whosinPricePerTrip = whosinPricePerTrip;
    }

    public Float getWhosinPricePerInfant() {
        return whosinPricePerInfant;
    }

    public void setWhosinPricePerInfant(Float whosinPricePerInfant) {
        this.whosinPricePerInfant = whosinPricePerInfant;
    }

    public Float getWhosinPricePerChild() {
        return whosinPricePerChild;
    }

    public void setWhosinPricePerChild(Float whosinPricePerChild) {
        this.whosinPricePerChild = whosinPricePerChild;
    }

    public Float getWhosinPricePerAdult() {
        return whosinPricePerAdult;
    }

    public void setWhosinPricePerAdult(Float whosinPricePerAdult) {
        this.whosinPricePerAdult = whosinPricePerAdult;
    }

    public Float getTourGuideMarkup() {
        return tourGuideMarkup;
    }

    public void setTourGuideMarkup(Float tourGuideMarkup) {
        this.tourGuideMarkup = tourGuideMarkup;
    }
