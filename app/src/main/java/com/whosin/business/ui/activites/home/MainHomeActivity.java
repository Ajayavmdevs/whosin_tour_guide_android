...
import static com.whosin.business.comman.AppConstants.TabOption.valueOf;
...
import com.whosin.business.comman.AppDelegate;
import com.whosin.business.comman.Graphics;
import com.whosin.business.comman.Preferences;
import com.whosin.business.comman.Utils;
import com.whosin.business.databinding.ActivityMainHomeBinding;
...
import com.whosin.business.service.manager.AdManger;
...
import com.whosin.business.service.manager.LocationManager;
...
import com.whosin.business.service.models.InAppNotificationModel;
...
import com.whosin.business.ui.activites.auth.TwoFactorAuthActivity;
...
import com.whosin.business.ui.fragment.TicketReview.RaynaTicketReviewDialog;
...
//            Toast.makeText(this, "App is being closed by back button", Toast.LENGTH_SHORT).show();
    ...
    public void openProfileTab() {
        if (binding != null && binding.tabLayout.getTabCount() > 2) {
...
//            }
    ...
    private void showUpdateDialog() {
        ...
        builder.setPositiveButton("Update", (dialog, which) -> {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=com.whosin.business"));
            startActivity(intent);
        });
